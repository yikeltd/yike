-- Listing form ad slot + defensive property-media bucket config.

INSERT INTO ad_placements (placement_key, label)
VALUES ('agent_listing_form', 'Agent listing form — price step')
