...
**Enterprise Activation (pre-launch):** `.cursor/rules/enterprise-activation.mdc` · `docs/launch/ENTERPRISE_ACTIVATION_PROGRAM.md` · lifecycle `docs/architecture/CAPABILITY_LIFECYCLE.md`  
