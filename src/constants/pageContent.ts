export const RENT_FAQS = [
  {
    q: "How much should I budget for rent in Lagos?",
    a: "Self contains start around ₦400k–₦700k yearly in mid-budget areas. Family flats in Lekki, Ikeja or Surulere often run ₦1.5M–₦6M+. Always confirm agency fee, caution and agreement separately.",
  },
  {
  ...
  },
  {
    ...
    a: "The agent passed identity checks on Yike. It does not guarantee the property title or that the unit matches photos — always inspect in person.",
  },
  {
    q: "Can I find student housing near campus?",
    a: "Yes. Filter student areas like Yaba (UNILAG), Nekede (FUTO), Ugbowo (UNIBEN), and Tanke (UNILORIN). Look for self contains walking distance to gate.",
  },
];

export const BUY_FAQS = [
  {
    q: "Does Yike verify property ownership?",
    a: "No. Yike verifies agent identity where applicable, not title documents. Engage a lawyer for C of O, survey and deed checks before paying.",
  },
  {
    q: "What should I check before buying a house?",
    a: "Physical inspection, title search, survey plan, building approvals, neighbourhood access, and written sale agreement with clear payment milestones.",
  },
  {
    q: "Which cities are popular for property investment?",
    a: "Lagos, Abuja, Port Harcourt, Ibadan and fast-growing corridors like Ajah, Lugbe and Asaba attract investors — but due diligence is essential everywhere.",
  },
  {
    q: "Can I contact sellers on WhatsApp?",
    a: "Yes. Every listing shows WhatsApp contact. Ask specific questions about documentation and schedule a physical viewing before any transfer.",
  },
];
...
export const SHORTLET_FAQS = [
  {
    ...
    a: "Prices are usually per night or per day. Confirm cleaning fees, caution deposit and ID requirements with the host on WhatsApp before booking.",
  },
  {
    q: "Are shortlet hosts verified?",
    a: "Many hosts are verified agents on Yike. Look for the Verified badge and read reviews in chat — inspect or confirm address before paying.",
  },
  {
    q: "Best cities for business travel shortlets?",
    a: "Lagos (VI, Ikoyi, Lekki), Abuja (Wuse, Maitama), Port Harcourt GRA and Owerri Ikenegbu have strong serviced apartment options.",
  },
  {
...
export const LAND_FAQS = [
  {
    q: "Does Yike verify land titles?",
    a: "No. We do not verify C of O, deed of assignment or survey plans. Use a qualified property lawyer and conduct official searches before payment.",
  },
  {
    q: "Red flags when buying land in Nigeria",
    a: "Pressure to pay quickly, no physical inspection, vague location pins, duplicate listings, and sellers who refuse lawyer involvement.",
  },
  {
    q: "Which areas are developing fast?",
    a: "Corridors like Ajah–Sangotedo, Lugbe–Kubwa, Asaba–Okpanam and outskirts of Enugu, Uyo and Abeokuta see active plot sales — verify government layout status.",
  },
  {
    q: "Commercial vs residential land?",
    a: "Commercial plots suit shops, plazas and warehouses. Confirm zoning, road width and community levies. Residential plots need layout approval and access road clarity.",
  },
];
