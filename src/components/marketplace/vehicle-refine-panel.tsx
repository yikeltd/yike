...
import { VehicleRefineFilters } from "./vehicle-refine-filters";
import { cn } from "@/lib/utils";

/** Matches property SearchRefinePanel chrome. */
export function VehicleRefinePanel({
  defaultOpen = false,
  className,
}: {
  defaultOpen?: boolean;
  ...
  return (
    ...
    >
      ...
      {open ? (
        <VehicleRefineFilters className="border-t border-navy/6" />
      ) : null}
    </div>
  );
}
