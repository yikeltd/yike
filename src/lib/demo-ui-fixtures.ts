...
const VEHICLE_SEEDS: VehSeed[] = [
  ...
  {
    id: "demo-mp-veh-velar-01",
    agent: 2,
    title: "Range Rover Velar 2018 — luxury SUV",
    description:
      "Stunning Velar R-Dynamic with Meridian sound system and digital cockpit.",
    price: 25_000_000,
    state: "Lagos",
    city: "Lagos",
    ...
    vehicle_condition: "foreign_used",
    boosted: true,
    photos: VEHICLE_PHOTOS.slice(1, 4),
    daysAgo: 1,
  },
  {
    id: "demo-mp-veh-man-01",
    agent: 3,
    title: "MAN TGS 40.400 — commercial heavy truck",
    description:
      "Heavy duty MAN TGS tipper truck in excellent mechanical condition.",
    price: 85_000_000,
    state: "Lagos",
    city: "Lagos",
    area: "Oshodi",
    ...
    vehicle_condition: "foreign_used",
    boosted: true,
    photos: VEHICLE_PHOTOS.slice(9, 10).concat(VEHICLE_PHOTOS.slice(6, 8)),
    daysAgo: 2,
  },
  {
    id: "demo-mp-veh-fortuner-01",
    agent: 2,
    title: "Toyota Fortuner 2019 — 7-seater SUV",
    description:
      "Clean 7-seater Fortuner with leather interior and strong 4WD capability.",
    price: 23_000_000,
    state: "FCT",
    city: "Abuja",
  ...
  {
    id: "demo-mp-veh-gle-01",
    agent: 2,
    title: "Mercedes-Benz GLE 450 2020 — luxury SUV",
    description:
      "Executive GLE 450 AMG-line with panoramic roof and ambient lighting.",
    price: 38_500_000,
    state: "FCT",
    city: "Abuja",
    area: "Maitama",
  ...
  {
    id: "demo-mp-veh-audi-01",
    agent: 2,
    title: "Audi Q7 2019 — 7-seater luxury SUV",
    description:
      "Quattro AWD Q7 with Bang & Olufsen sound, virtual cockpit, and air suspension.",
    price: 27_400_000,
    state: "Lagos",
    city: "Lagos",
    area: "Ikoyi",
  ...
  {
    id: "demo-mp-veh-l200-01",
    agent: 1,
    title: "Mitsubishi L200 2020 — double cab pickup",
    description:
      "Heavy duty Triton L200 4WD pickup with tub liner and tow hitch.",
    price: 17_800_000,
    state: "Edo",
    city: "Benin",
    area: "GRA",
    ...
    vehicle_condition: "foreign_used",
    boosted: false,
    photos: VEHICLE_PHOTOS.slice(8, 10).concat(VEHICLE_PHOTOS.slice(0, 2)),
    daysAgo: 4,
  },
  {
    id: "demo-mp-veh-gwagon-01",
    agent: 3,
    title: "Mercedes-AMG G63 2021 — luxury SUV",
    description:
      "Night Edition G63 AMG with designo leather, carbon trim, and V8 biturbo engine.",
    price: 120_000_000,
    state: "Lagos",
    city: "Lagos",
    area: "Banana Island",
    ...
    vehicle_condition: "foreign_used",
    boosted: true,
    photos: VEHICLE_PHOTOS.slice(0, 5),
    daysAgo: 1,
  },
];
