...
const PROPERTIES: DemoProperty[] = [
  ...
  {
    id: "d2000001-0000-4000-8000-00000000000b",
    sellerId: SELLERS[1].id,
    title: "3-bed bungalow — Jimeta Yola",
    description:
      "Family bungalow in Jimeta with borehole, tiled floors, and fenced compound. Quiet street near Modern Market.",
    listing_type: "rent",
    property_type: "bungalow",
    bedrooms: 3,
    bathrooms: 2,
    ...
    city: "Yola",
    area: "Jimeta",
    address_hint: "Jimeta housing layout",
    ...
    tier: "standard",
    boosted: true,
    images: PROPERTY_PHOTOS.slice(2, 5),
  },
  {
    id: "d2000001-0000-4000-8000-00000000000c",
    sellerId: SELLERS[0].id,
    title: "Self contain — Dougirei Yola",
    description:
      "Neat self contain close to campus road with prepaid meter. Ideal for students and young professionals.",
    listing_type: "rent",
    ...
    city: "Yola",
    area: "Dougirei",
    address_hint: "Dougirei campus road",
    landmark: "Near ATBU axis",
    parking: 0,
    size_sqm: 28,
    lat: 9.2035,
    lng: 12.4954,
    amenities: ["prepaid_meter"],
    tier: "budget",
    boosted: false,
    images: PROPERTY_PHOTOS.slice(3, 5),
  },
  {
    id: "d2000001-0000-4000-8000-00000000000d",
    sellerId: SELLERS[3].id,
    ...
    city: "Lagos",
    area: "Lekki Phase 1",
    address_hint: "Lekki Phase 1 estate",
    landmark: "Close to Admiralty Way",
    parking: 2,
    size_sqm: 110,
    lat: 6.4698,
    lng: 3.5852,
    amenities: ["parking", "generator", "security", "fitted_kitchen", "water"],
    tier: "premium",
    boosted: true,
    images: PROPERTY_PHOTOS.slice(0, 4),
  },
  {
    id: "d2000001-0000-4000-8000-00000000000e",
    sellerId: SELLERS[1].id,
    title: "4-bed duplex — Wuse 2 Abuja",
    description:
      "Executive duplex in Wuse 2 with BQ, borehole, and covered parking. Suitable for diplomatic or corporate housing.",
    listing_type: "rent",
    property_type: "detached_duplex",
    bedrooms: 4,
    bathrooms: 4,
    ...
    city: "Abuja",
    area: "Wuse 2",
    address_hint: "Wuse 2 residential",
    landmark: "Near Wuse Market",
    parking: 3,
    size_sqm: 260,
    lat: 9.0765,
    lng: 7.4805,
    amenities: ["parking", "bq", "water", "security", "generator"],
    tier: "premium",
    boosted: true,
    images: PROPERTY_PHOTOS.slice(1, 5),
  },
  {
    id: "d2000001-0000-4000-8000-00000000000f",
    sellerId: SELLERS[1].id,
    title: "3-bed bungalow — State Housing Calabar",
    description:
      "Quiet bungalow in State Housing Estate with tiled floors and fenced compound. Close to Cultural Centre.",
    listing_type: "rent",
    property_type: "bungalow",
    bedrooms: 3,
    bathrooms: 2,
    ...
    city: "Calabar",
    area: "State Housing",
    address_hint: "State Housing Estate",
  ...
  },
  {
    ...
    description:
      "Busy frontage shop on Ogui Road — prepaid meter, rolling shutter, and storage loft. Strong daily foot traffic.",
    listing_type: "lease",
    property_type: "shop",
    bedrooms: 0,
    bathrooms: 1,
    ...
    city: "Enugu",
    area: "Ogui",
    address_hint: "Ogui Road frontage",
    landmark: "Opposite Shoprite axis",
    parking: 0,
    size_sqm: 35,
    lat: 6.4413,
    lng: 7.4985,
    amenities: ["prepaid_meter", "security"],
    tier: "standard",
    boosted: true,
    images: PROPERTY_PHOTOS.slice(6, 9),
  },
  {
    ...
    description:
      "Furnished open-plan office with AC, parking for 4 cars, and fibre-ready cabling near Industrial Layout.",
    listing_type: "lease",
    property_type: "office",
    bedrooms: 0,
    bathrooms: 2,
    ...
    city: "Port Harcourt",
    area: "Trans Amadi",
    address_hint: "Trans Amadi Industrial Layout",
    landmark: "Near Industrial Layout gate",
    parking: 4,
    size_sqm: 140,
    lat: 4.8156,
    lng: 7.0498,
    amenities: ["parking", "fibre", "generator", "security"],
    tier: "standard",
    boosted: false,
    images: PROPERTY_PHOTOS.slice(7, 10),
  },
  {
    ...
    description:
      "Dry half plot with survey plan available. Ideal for duplex build close to Ibom Tropicana.",
    listing_type: "sale",
    property_type: "land",
    bedrooms: 0,
    bathrooms: 0,
    ...
    tier: "standard",
    boosted: true,
    images: PROPERTY_PHOTOS.slice(8, 10),
  },
];
...
const VEHICLES: DemoVehicle[] = [
  ...
  {
    id: "d3000001-0000-4000-8000-00000000000b",
    sellerId: SELLERS[2].id,
    title: "Toyota Corolla 2019 — reliable sedan",
    description:
      "Tokunbo Corolla with chilled AC, reverse camera, and clean service booklet. Surulere viewing.",
    price: 11_200_000,
    state: "Lagos",
    city: "Lagos",
    area: "Surulere",
    ...
    registration_status: "registered",
    boosted: true,
    images: VEHICLE_PHOTOS.slice(0, 3),
  },
  {
    id: "d3000001-0000-4000-8000-00000000000c",
    sellerId: SELLERS[2].id,
    title: "Toyota Land Cruiser Prado 2016 — SUV",
    description:
      "Rugged Prado with 4WD, leather seats, and recent suspension service. Ideal Abuja family SUV.",
    price: 28_500_000,
    state: "FCT",
    city: "Abuja",
    area: "Gwarinpa",
  ...
  {
    id: "d3000001-0000-4000-8000-00000000000d",
    sellerId: SELLERS[2].id,
    title: "Toyota Hilux 2018 — double cab",
    description:
      "Work-ready Hilux with canopy, bull bar, and strong engine compression. Port Harcourt papers ready.",
    price: 22_800_000,
    state: "Rivers",
    city: "Port Harcourt",
    area: "Rumuokoro",
    ...
    registration_status: "registered",
    boosted: false,
    images: VEHICLE_PHOTOS.slice(9, 10).concat(VEHICLE_PHOTOS.slice(1, 3)),
  },
  {
    id: "d3000001-0000-4000-8000-00000000000e",
    sellerId: SELLERS[1].id,
    title: "Honda Accord 2017 — sport sedan",
    description:
      "Sharp Accord with sunroof, keyless entry, and freshly done alignment. Available for Enugu viewing.",
    price: 9_750_000,
    state: "Enugu",
    city: "Enugu",
    area: "New Haven",
    ...
    registration_status: "registered",
    boosted: true,
    images: VEHICLE_PHOTOS.slice(2, 5),
  },
];
  ...
  const { error: profileError } = await admin.from("profiles").upsert(
    {
      ...
      phone_verified: true,
      email_verified: true,
      // Seed sellers need a high cap (NULL still defaults to 5 in check_agent_listing_limit)
      listing_limit: 100,
      listing_limit_reason: "seed:demo-marketplace",
      listing_limit_updated_at: new Date().toISOString(),
      subscription_plan_code: "developer",
    },
    { onConflict: "id" },
  );
  if (profileError) {
